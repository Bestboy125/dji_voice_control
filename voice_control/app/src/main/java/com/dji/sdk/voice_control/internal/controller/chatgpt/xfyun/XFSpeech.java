...
public class XFSpeech implements IXFSpeech {
    ...
    public XFSpeech(Context context, InitListener mInitListener) {
        ...
        SpeechUtility.createUtility(DJISampleApplication.getContext(), SpeechConstant.APPID + "=" + "");
...
//        mIat = SpeechRecognizer.createRecognizer(this, mInitListener);
    ...
    private void setSpeechParam() {
        ...
        mTts.setParameter(SpeechConstant.TTS_AUDIO_PATH, DJISampleApplication.getContext().getExternalFilesDir("msc").getAbsolutePath() + "/tts.pcm");
    }
    ...
    public void speechStartSaying(String question, SynthesizerListener listener) {
        ...
        pcmFile = new File(DJISampleApplication.getContext().getExternalCacheDir().getAbsolutePath(), "tts_pcmFile.pcm");
        pcmFile.delete();
    ...
    public void setRecognizerParam() {
        ...
        mIatDialog.setParameter(SpeechConstant.ASR_AUDIO_PATH, DJISampleApplication.getContext().getExternalFilesDir("msc").getAbsolutePath() + "/iat.wav");
    }
