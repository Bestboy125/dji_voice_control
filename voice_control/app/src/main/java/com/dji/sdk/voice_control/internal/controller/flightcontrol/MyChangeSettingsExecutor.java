...
public class MyChangeSettingsExecutor {
    ...
    public static void mEnableVS() {
        FlightController fc = DJISampleApplication.getFlightController();
        if(fc!=null){
    ...
    public static void setGoHomeHeightInMeters(float height){
        FlightController fc = DJISampleApplication.getFlightController();
        if(fc!=null){
            fc.setGoHomeHeightInMeters((int) height,new CommonCallbacks.CompletionCallback() {
                @Override
                public void onResult(DJIError djiError) {
    ...
    public static void setMaxFlightHeight(float maxHeight){
        FlightController fc = DJISampleApplication.getFlightController();
        if(fc!=null){
            fc.setMaxFlightHeight((int) maxHeight,new CommonCallbacks.CompletionCallback() {
                @Override
                public void onResult(DJIError djiError) {
