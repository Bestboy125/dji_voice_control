package com.dji.sdk.voice_control.internal.view;
...
import com.dji.sdk.voice_control.demo.accessory.AccessoryAggregationView;
import com.dji.sdk.voice_control.demo.accessory.AudioFileListManagerView;
import com.dji.sdk.voice_control.demo.airlink.RebootWiFiAirlinkView;
import com.dji.sdk.voice_control.demo.airlink.SetGetOcuSyncLinkView;
import com.dji.sdk.voice_control.demo.airlink.SetGetWiFiLinkSSIDView;
import com.dji.sdk.voice_control.demo.appactivation.AppActivationView;
import com.dji.sdk.voice_control.demo.battery.PushBatteryDataView;
...
import com.dji.sdk.voice_control.demo.camera.PlaybackDownloadView;
import com.dji.sdk.voice_control.demo.camera.PlaybackPushInfoView;
import com.dji.sdk.voice_control.demo.camera.PushCameraDataView;
import com.dji.sdk.voice_control.demo.camera.RecordVideoView;
import com.dji.sdk.voice_control.demo.camera.SetGetISOView;
import com.dji.sdk.voice_control.demo.camera.ShootSinglePhotoView;
import com.dji.sdk.voice_control.demo.camera.ShootSuperResolutionPhotoView;
import com.dji.sdk.voice_control.demo.camera.VideoFeederView;
import com.dji.sdk.voice_control.demo.camera.XT2CameraView;
import com.dji.sdk.voice_control.demo.datalocker.AccessLockerView;
import com.dji.sdk.voice_control.demo.firmwareupgrade.FirmwareUpgradeView;
import com.dji.sdk.voice_control.demo.flightcontroller.CompassCalibrationView;
import com.dji.sdk.voice_control.demo.flightcontroller.FlightAssistantPushDataView;
import com.dji.sdk.voice_control.demo.flightcontroller.FlightHubView;
import com.dji.sdk.voice_control.demo.flightcontroller.FlightLimitationView;
import com.dji.sdk.voice_control.demo.flightcontroller.NetworkRTKView;
import com.dji.sdk.voice_control.demo.flightcontroller.OrientationModeView;
import com.dji.sdk.voice_control.demo.flightcontroller.VirtualStickView;
import com.dji.sdk.voice_control.demo.gimbal.GimbalCapabilityView;
import com.dji.sdk.voice_control.demo.gimbal.MoveGimbalWithSpeedView;
...
import com.dji.sdk.voice_control.demo.missionoperator.WaypointV2MissionOperatorView;
import com.dji.sdk.voice_control.demo.mobileremotecontroller.MobileRemoteControllerView;
import com.dji.sdk.voice_control.demo.radar.RadarView;
import com.dji.sdk.voice_control.demo.remotecontroller.DualRemoteControllerView;
import com.dji.sdk.voice_control.demo.remotecontroller.PushRemoteControllerDataView;
import com.dji.sdk.voice_control.demo.rid.UASView;
import com.dji.sdk.voice_control.demo.timeline.TimelineMissionControlView;
import com.dji.sdk.voice_control.demo.useraccount.LDMView;
import com.dji.sdk.voice_control.internal.controller.DJISampleApplication;
import com.dji.sdk.voice_control.internal.controller.ExpandableListAdapter;
import com.dji.sdk.voice_control.internal.controller.MainActivity;
import com.dji.sdk.voice_control.internal.model.GroupHeader;
import com.dji.sdk.voice_control.internal.model.GroupItem;
import com.dji.sdk.voice_control.internal.model.ListItem;
