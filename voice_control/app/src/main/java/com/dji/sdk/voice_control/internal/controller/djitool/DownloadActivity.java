package com.dji.sdk.voice_control.internal.controller.djitool;
...
public class DownloadActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUI();
        DJISampleApplication.getAircraftInstance().getCamera().setStorageStateCallBack(new StorageState.Callback() {
            @Override
            public void onUpdate(@NonNull @NotNull StorageState storageState) {
                if(storageState.isInserted()) {
                    ...
                    DJISampleApplication.getAircraftInstance().getCamera().setStorageLocation(SettingsDefinitions.StorageLocation.SDCARD, new CommonCallbacks.CompletionCallback() {
                        @Override
                    ...
                    DJISampleApplication.getAircraftInstance().getCamera().setStorageLocation(SettingsDefinitions.StorageLocation.INTERNAL_STORAGE, new CommonCallbacks.CompletionCallback() {
                        @Override
                        public void onResult(DJIError djiError) {
                        }
                    });
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(DownloadActivity.this, RecyclerView.VERTICAL,false);
        ...
        //Init Loading Dialog
        mLoadingDialog = new ProgressDialog(DownloadActivity.this);
        mLoadingDialog.setMessage("Please wait");
        mLoadingDialog.setCanceledOnTouchOutside(false);
        mLoadingDialog.setCancelable(false);

        //Init Download Dialog
        mDownloadDialog = new ProgressDialog(DownloadActivity.this);
